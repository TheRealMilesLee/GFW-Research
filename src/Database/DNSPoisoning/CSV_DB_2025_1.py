...
def dump_to_mongo():
  ...
  if os.name == 'nt':
    ...
    FileFolderLocation = '/home/silverhand/Developer/SourceRepo/GFW-Research/Lib/Data-2025-1/ChinaMobile/DNSPosioning'
  csv_files = [
  ...
  CM_DNSP_ADC_JAN.create_index([('domain', 1), ('dns_server', 1),
                                ('timestamp', 1)],
