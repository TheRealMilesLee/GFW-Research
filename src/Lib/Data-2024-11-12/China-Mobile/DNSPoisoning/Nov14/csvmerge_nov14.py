...
if __name__ == "__main__":
  if os.name == 'nt':
    folder_paths = [
      "E:\\Developer\\SourceRepo\\GFW-Research\\src\\Lib\\Data-2024-11-12\\China-Mobile\\DNSPoisoning\\Nov14"
    ]
    output_file_path = "E:\\Developer\\SourceRepo\\GFW-Research\\Lib\\Data-2024-11\\ChinaMobile\\merged_2024_11_14.csv"
  else:
    folder_paths = [
      "/Users/silverhand/Developer/SourceRepo/GFW-Research/src/Lib/Data-2024-11-12/China-Mobile/DNSPoisoning/Nov14"
    ]
    output_file_path = "/Users/silverhand/Developer/SourceRepo/GFW-Research/Lib/Data-2024-11/ChinaMobile/merged_2024_11_14.csv"
